...
public class ProximityAlertService implements IProximityAlertService {
	...
	public boolean addProximityAlert(TaskDTO dto) {
		...
		locationManager.addProximityAlert((double) (Integer.parseInt((dto
				.getLocalisation().getLatitude())) / 1000000),
				(double) (Integer.parseInt((dto.getLocalisation()
						.getLongitude())) / 1000000), radius,
